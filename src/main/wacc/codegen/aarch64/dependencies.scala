...
object Dependencies {
  ...
  private final val PREFIX: String = "src/main/wacc/codegen/aarch64/branchLinks/"
...
class Dependencies() {
  ...
  def addDependency(predefinedLabel: Dependency): Unit = {
    ...
    predefinedLabel match {
      case ArrLoad1 | ArrLoad4 | ArrLoad8 | ArrStore1 | ArrStore4 | ArrStore8 => addDependency(ErrOutOfBounds)
